...
(function init() {
  ...
  for (var i = 0; i < galleryItems.length; i++) {
    ...
    return(
        <div className="body_mr">
            <div className="container">
  
  <div className="feature">
    <figure className="featured-item image-holder r-3-2 transition"></figure>
  </div>
  
  <div className="gallery-wrapper">
    <div className="gallery">
        <div className="item-wrapper">
          <figure className="gallery-item image-holder r-3-2 active transition"></figure>
        </div>
        <div clclassNameass="item-wrapper">
          <figure className="gallery-item image-holder r-3-2 transition"></figure>
        </div>
        <div className="item-wrapper">
          <figure className="gallery-item image-holder r-3-2 transition"></figure>
        </div>
        ...
        <div className="item-wrapper">
          <figure className="gallery-item image-holder r-3-2"></figure>
        </div>
        <div className="item-wrapper">
          <figure className="gallery-item image-holder r-3-2 transition"></figure>
        </div>
